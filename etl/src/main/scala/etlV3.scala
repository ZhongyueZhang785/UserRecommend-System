...
object etlV3 {
  def main(args: Array[String]): Unit = {
    ...
    tweetDF
      ...
      .option("header", "false")
      .option("encoding", "UTF-8")
      .csv("file:/D:/Jack/PycharmProjects/NoeatNosleep2021-F21/etl/src/main/resources/tweet_csv_no_base64")
    ...
    userDF
      ...
      .option("delimiter", "\t")
      .option("header", "false")
      .csv("file:/D:/Jack/PycharmProjects/NoeatNosleep2021-F21/etl/src/main/resources/user_csv_no_base64")
    ...
    contactDF
      ...
      .option("header", "false")
      .option("encoding", "UTF-8")
      .csv("file:/D:/Jack/PycharmProjects/NoeatNosleep2021-F21/etl/src/main/resources/contact_csv_no_base64")
  }
}
