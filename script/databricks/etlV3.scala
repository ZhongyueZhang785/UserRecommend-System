...
val popularHashTagDF = spark.read.option("header", "false")
  .csv("s3://twitter-nens/popular_hashtags.txt")
  .toDF("hash_tag")
...
tweetDF
  ...
  .csv("s3://twitter-nens/full_aurora/tweet_csv")
...
tweetDF
  ...
  .option("header", "false")
  .option("encoding", "UTF-8")
  .csv("s3://twitter-nens/full_aurora/tweet_csv_no_base64")
...
val replyTweetDF = replyTweetDFAll
  ...
  .agg(collect_set(
    to_json(struct(col("user_id"), col("screen_name"), col("description"), col("hash_tag")))
...
val retweetTweetDF = retweetTweetDFAll
...
userDF
  ...
  .option("delimiter", "\t")
  .option("header", "false")
  .csv("s3://twitter-nens/full_aurora/user_csv")
...
userDF
  ...
  .option("delimiter", "\t")
  .option("header", "false")
  .csv("s3://twitter-nens/full_aurora/user_csv_no_base64")
...
contactDF
  ...
  .option("header", "false")
  .option("encoding", "UTF-8")
  .csv("s3://twitter-nens/full_aurora/contact_csv")
...
contactDF
  ...
  .option("header", "false")
  .option("encoding", "UTF-8")
  .csv("s3://twitter-nens/full_aurora/contact_csv_no_base64")
