...
//import twitter_utils.SendTweet;
//import twitter_utils.UserRow;
//
...
//
//
//    public void updateUserInforamtion(String str,String type,String hashtagRequest) throws JSONException {
...
//                    calculateKeyScore(tweet_list,user_id,hashtagRequest);//calculate key score
//                    calculateHashTagScore(hashTag,user_id);//calculate hashtag score
...
//    }
//
//    private void calculateKeyScore(String tweet_list, String user_id,String hashtag) throws JSONException {
//        if (!tweet_list.equals("")) {
//            JSONArray jsonArr = new JSONArray(tweet_list);
//            for (int i = 0; i < jsonArr.length(); i++) {
//                if (!jsonArr.isNull(i)) {
