...
public class UserRow {
    ...
    public UserRow(String user_id,String hashTag, String description, String screen_name,double score) {
        this.user_id = user_id;
    ...
    public void calculateFinalHashTagScore() {
        if (same_tag_count > 10) {
            ...
            this.score = this.score * hashtag_score;
        } else {
            this.score = this.score * 1;
        }
    }

    public void setScore(String user_id,double score) {
        this.score = score;
        this.user_id = user_id;
    }
