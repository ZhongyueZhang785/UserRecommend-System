...
import twitter_utils.Tweet;
import twitter_utils.VerifyRequest;

import static java.util.concurrent.Executors.newSingleThreadExecutor;

public final class P4Application extends HttpServerLauncher {
    ...
    public P4Application() throws IOException, SQLException {
...
//        return newSingleThreadExecutor();
    ...
    AsyncServlet servlet(Executor executor) {
        return RoutingServlet.create().map(GET, "/", request -> {
            ...
            if (verifyRequest.verify()) {
                Tweet tweet = new Tweet(connection);
    ...
    public static void main(String[] args) throws Exception {
        Launcher launcher = new P4Application();
