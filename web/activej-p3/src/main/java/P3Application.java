...
public final class P3Application extends HttpServerLauncher {

    private static Connection connection;
//    private String address = "aurora-from-snapshot.cf6apywz25dq.us-east-1.rds.amazonaws.com";
//    private String dbName = "twitter_aurora";
    private static String user;
    private static String password;
    private static String address;
    private static String dbName;

    public P3Application() throws IOException, SQLException {
...
//        return newSingleThreadExecutor();
    ...
    AsyncServlet servlet(Executor executor) {
        return RoutingServlet.create().map(GET, "/", request -> {
            ...
            if (verifyRequest.verify()) {
                Tweet2 tweet = new Tweet2(connection);
    ...
    public static void main(String[] args) throws Exception {
        Launcher launcher = new P3Application();
